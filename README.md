...
[![godocs.io](https://godocs.io/github.com/iampsl/go-imap?status.svg)](https://godocs.io/github.com/iampsl/go-imap)
...
### Client [![godocs.io](https://godocs.io/github.com/iampsl/go-imap/client?status.svg)](https://godocs.io/github.com/iampsl/go-imap/client)
...
import (
	...
	"github.com/iampsl/go-imap/client"
...
### Server [![godocs.io](https://godocs.io/github.com/iampsl/go-imap/server?status.svg)](https://godocs.io/github.com/iampsl/go-imap/server)
...
import (
	...
	"github.com/iampsl/go-imap/server"
	"github.com/iampsl/go-imap/backend/memory"
)
...
wiki](https://github.com/iampsl/go-imap/wiki/Using-extensions#using-client-extensions)
to learn how to use them.

* [COMPRESS](https://github.com/iampsl/go-imap-compress)
* [ID](https://github.com/ProtonMail/go-imap-id)
* [METADATA](https://github.com/iampsl/go-imap-metadata)
* [NAMESPACE](https://github.com/foxcpp/go-imap-namespace)
* [QUOTA](https://github.com/iampsl/go-imap-quota)
* [SORT and THREAD](https://github.com/iampsl/go-imap-sortthread)
* [UIDPLUS](https://github.com/iampsl/go-imap-uidplus)

### Server backends

* [Memory](https://github.com/iampsl/go-imap/tree/master/backend/memory) (for testing)
* [Multi](https://github.com/iampsl/go-imap-multi)
* [PGP](https://github.com/iampsl/go-imap-pgp)
* [Proxy](https://github.com/iampsl/go-imap-proxy)
